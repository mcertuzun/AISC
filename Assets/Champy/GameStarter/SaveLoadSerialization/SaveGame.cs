...
namespace Champy.GameStarter.SaveLoadSerialization
{
    ...
    public static class SaveGame
    {
        ...
        public delegate void SaveHandler(object obj, string identifier, bool encode, string password,
            ISerializer serializer, IEncoder encoder, Encoding encoding, SaveGamePath path);
        ...
        private static ISerializer m_Serializer = new JsonSerializer();
        private static IEncoder m_Encoder = new SimpleEncoder();
        ...
        private static string m_EncodePassword = "c#n@T$T&o]c^";
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="SaveGame"/> encrypt data by default.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="SaveGame"/> log error.
        /// </summary>
        ...
        /// Saves data using the identifier.
        /// </summary>
        public static void Save<T>(string identifier, T obj, bool encode, string password, ISerializer serializer,
            IEncoder encoder, Encoding encoding, SaveGamePath path)
        {
            ...
            if (encode)
            {
                string data = Convert.ToBase64String(((MemoryStream) stream).ToArray());
        ...
        {
            return Load<T>(identifier, default(T), Encode, EncodePassword, Serializer, Encoder, DefaultEncoding,
                SavePath);
        }
        ...
        {
            return Load<T>(identifier, defaultValue, Encode, EncodePassword, Serializer, Encoder, DefaultEncoding,
                SavePath);
        }
        ...
        /// <typeparam name="T">The 1st type parameter.</typeparam>
        public static T Load<T>(string identifier, ISerializer serializer)
        {
            return Load<T>(identifier, default(T), Encode, EncodePassword, serializer, Encoder, DefaultEncoding,
                SavePath);
        }
        ...
        /// <typeparam name="T">The 1st type parameter.</typeparam>
        public static T Load<T>(string identifier, IEncoder encoder)
        {
            return Load<T>(identifier, default(T), Encode, EncodePassword, Serializer, encoder, DefaultEncoding,
                SavePath);
        }
        ...
        /// <param name="serializer">Serializer.</param>
        /// <typeparam name="T">The 1st type parameter.</typeparam>
        public static T Load<T>(string identifier, T defaultValue, ISerializer serializer)
        {
            return Load<T>(identifier, defaultValue, Encode, EncodePassword, serializer, Encoder, DefaultEncoding,
                SavePath);
        }
        ...
        /// <param name="encoder">Encoder.</param>
        /// <typeparam name="T">The 1st type parameter.</typeparam>
        public static T Load<T>(string identifier, T defaultValue, IEncoder encoder)
        {
            return Load<T>(identifier, defaultValue, Encode, EncodePassword, Serializer, encoder, DefaultEncoding,
                SavePath);
        }
        ...
        /// <typeparam name="T">The 1st type parameter.</typeparam>
        public static T Load<T>(string identifier, T defaultValue, bool encode, string password, ISerializer serializer,
            IEncoder encoder, Encoding encoding, SaveGamePath path)
        {
            if (string.IsNullOrEmpty(identifier))
            {
            ...
            if (encode)
            {
                ...
                stream = new MemoryStream(Convert.FromBase64String(decoded), true);
            }
            else
            {
#if !UNITY_SAMSUNGTV && !UNITY_TVOS && !UNITY_WEBGL
