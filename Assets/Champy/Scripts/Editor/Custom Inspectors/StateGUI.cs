...
namespace Champy.AI.Editor
{
    ...
    public class StateGUI : UnityEditor.Editor
    {
        ...
        void SetupReordableLists()
        {
            ...
            onFixedList = new ReorderableList(serializedState, serializedState.FindProperty("onFixed"), true, true,
                true, true);
            onUpdateList = new ReorderableList(serializedState, serializedState.FindProperty("onUpdate"), true, true,
                true, true);
            onEnterList = new ReorderableList(serializedState, serializedState.FindProperty("onEnter"), true, true,
                true, true);
            onExitList = new ReorderableList(serializedState, serializedState.FindProperty("onExit"), true, true, true,
                true);
            Transitions = new ReorderableList(serializedState, serializedState.FindProperty("transitions"), true, true,
                true, true);
